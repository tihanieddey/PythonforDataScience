...
# objsize is not a build it in module
# it is a thirdparty module which is hosted as pypi repository
# you must install it using pip install thirdpartymodule
# pip install objsize
import objsize
# get_deep_size is not a mthod 
# eventhough we have the signature object.method 
# in this particular case it is not object.method 
...
# memory_profiler is not is not a build in module
# it is a thirdparty module which is hosted as pypi repository
# you must install it using pip install thirdpartymodule
